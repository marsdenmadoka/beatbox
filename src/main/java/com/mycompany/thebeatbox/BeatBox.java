 ...
 */
package com.mycompany.thebeatbox;
...
background.setBorder(BorderFactory.createEmptyBorder(10,10,10,10));//distance from the edge of the frame
checkboxList = new ArrayList<JCheckBox>();//or checkboxList = new ArrayList<>();
